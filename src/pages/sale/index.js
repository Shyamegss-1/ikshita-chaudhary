...
import './style.css';
import { Col, Row, Select, Badge } from 'antd';
              ...
              return (
                <Col key={e + e - 1 * 0} md={12} sm={12} xs={24} lg={12} xl={8} xxl={8}>
                  <Badge.Ribbon
                    text="sale"
                    color="black"
                    style={i % 2 == 0 ? { display: 'none' } : { display: 'block' }}>
                    <ProductCard
                      setOpen={setOpen}
                      img={
                        'https://img2.ogaanindia.com/pub/media/catalog/product/cache/8e2c2a9d4851ee802ebff3c1680adbd5/k/r/kr2621.jpg'
                      }
                    />
                  </Badge.Ribbon>
                </Col>

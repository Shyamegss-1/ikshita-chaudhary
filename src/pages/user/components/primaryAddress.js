  ...
  return (
    <div>
      ...
      <Row justify="center" wrap>
        ...
        <Col md={15} sm={22} xs={22} lg={14} xl={13} xxl={11} className="user-address">
              ...
              <div className="edit-block">
                <div className="edit-content">
                  <div className="edit-data">
                    ...
                    <div className="edit-field">
                      <div className="field-left">
                        <label className="text-field">Company</label>
                      </div>
                      <div className="field-right">
                    ...
                    <div className="edit-field">
                      <div className="field-left">
                        <label className="text-field">Telephone</label>
                      </div>
                      <div className="field-right">
                        <label className="edit-text">
                          <TextField
                    ...
                    <div className="edit-field">
                      <div className="field-left">
                        <label className="text-field">Fax</label>
                      </div>
                      <div className="field-right">
                        <label className="edit-text">
                          <TextField
                  ...
                  <div className="edit-data">
                    ...
                    <div className="edit-field">
                      <div className="field-left">
                        <label className="text-field">State/Province</label>
                      </div>
                      <div className="field-right region-block">
                        <label className="edit-text">
                          <TextField
                            placeholder={'Region'}
                            id={'region'}
                    ...
                    <div className="edit-field">
                      <div className="field-left">
                        <label className="text-field">City</label>
                      </div>
                      <div className="field-right">
                        <label className="edit-text">
                          <TextField
                    ...
                    <div className="edit-field">
                      <div className="field-left">
                        <label className="text-field">Zip</label>
                      </div>
                      <div className="field-right">
                        <label className="edit-text">
                          <TextField
                    ...
                    <div className="edit-field">
                      <div className="field-left">
                        <label className="text-field">Street Address</label>
                      </div>
                      <div className="field-right">
                        <label className="edit-text">
                          <TextField
                    ...
                    <div className="edit-field">
                      <div className="field-left">
                        <label className="text-field">Street Address 2</label>
                      </div>
                      <div className="field-right">
                        <label className="edit-text">
                          <TextField
                  ...
                  <div className="default-address">
                    <div className="same-address">Default Billing Address</div>
                    <div className="same-address">Default Shipping Address</div>
                  </div>
                  ...
                  <div className="edit-buttons">
                    ...
                    <div className="buttons">
                      <label className="save-block">
                        <div className="save-btn">SAVE ADDRESS</div>
                      </label>
                    </div>
                  </div>
                </div>
